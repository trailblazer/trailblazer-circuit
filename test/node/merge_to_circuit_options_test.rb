...
class MergeToCircuitOptions_UnitTest < Minitest::Spec
  it "what" do
    ...
    my_node = Trailblazer::Circuit::Node::MergeToCircuitOptions.new(nil, :a, Trailblazer::Circuit::Task::Adapter::LibInterface::InstanceMethod_CircuitOptions)

    lib_ctx, flow_options, signal = my_node.({}, {application_ctx: {seq: []}}, nil, exec_context: my_exec_context)
